...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'jslib.wast';
  var wasmBinaryFile = 'jslib.wasm';
  var asmjsCodeFile = 'jslib.temp.asm.js';
...
Module['wasmTableSize'] = 257;

Module['wasmMaxTableSize'] = 257;
...
var real___GLOBAL__sub_I_bind_cpp_2 = asm["__GLOBAL__sub_I_bind_cpp_2"]; asm["__GLOBAL__sub_I_bind_cpp_2"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_bind_cpp_2.apply(null, arguments);
};
...
var __GLOBAL__sub_I_bind_cpp_2 = Module["__GLOBAL__sub_I_bind_cpp_2"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_bind_cpp_2"].apply(null, arguments) };
