...
EMSCRIPTEN_BINDINGS(my_class_example) {
  class_<ResponsiveAnalogRead>("ResponsiveAnalogRead")
    ...
    .function("smooth", select_overload<void(bool)>(&ResponsiveAnalogRead::smooth))
    .function("smooth_float", select_overload<void(float)>(&ResponsiveAnalogRead::smooth))
    .function("quick", &ResponsiveAnalogRead::quick)
